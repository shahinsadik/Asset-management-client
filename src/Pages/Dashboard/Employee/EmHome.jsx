  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const userTeamResponse = await axiosPublic.get(
          `/teams?email=${user?.email}`
        );
        setUserInTeam(userTeamResponse.data.inTeam);
        console.log(userTeamResponse?.data?.length);
      } catch (error) {
                          ...
                          <div className="card card-compact h-full bg-base-100 shadow-xl">
                            <div>
                              <div className="card-body">
                                ...
                                <h3>
                                  Product Type: {request.asset.productType}
                                </h3>
                                <h3>
                                  Product Quantity:{" "}
                                  {request.asset.productQuantity}
                                </h3>
